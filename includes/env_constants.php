 ...
 //print $host;die;
	switch($host)
    {
        case 'local.deliciouspakwan.com':
            ...
            define('BASEURL', 'http://local.deliciouspakwan.com');
			define('ERROR_LEVEL', E_ALL);
			define('PROFILER', TRUE);
			$commonPath = 'C:/xampp/htdocs/deliciouspakwan.com';
        ...
        default:
			...
			define('PROFILER', TRUE);
			$commonPath = '/home/buodw97cz4zw/public_html';
			define('HTDOCS_PATH', $commonPath);
			define('SYSTEM_PATH', $commonPath . '/system');
			define('APP_PATH', $commonPath . '/application');
			define('INCLUDE_PATH', '.;' . $commonPath . '/includes;');
	...
	//define('DP_YT_API_KEY', 'AIzaSyBvoa_cVYNcrQn8SqwaaVb3bCI2rGqxrpQ'); // OLD API KEY
	define('DP_YT_API_KEY', 'AIzaSyBvoa_cVYNcrQn8SqwaaVb3bCI2rGqxrpQ'); // New API KEY
//print 'TTT';die;	
